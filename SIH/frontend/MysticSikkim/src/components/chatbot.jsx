  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-r from-amber-500 to-yellow-600 rounded-full shadow-lg flex items-center justify-center text-white text-3xl hover:scale-110 hover:shadow-amber-500/50 transition-all duration-300 animate-bounce z-50"
      >
        🤖
      </button>

      {/* Chat Container with AnimatePresence */}
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ref={chatRef}
            ...
            className="fixed bottom-0 right-0 h-[80vh] w-96 bg-gradient-to-br from-amber-900/95 via-orange-800/95 to-yellow-900/95 shadow-2xl rounded-l-3xl border border-amber-400/20 backdrop-blur-xl flex flex-col z-40"
          >
            {/* Header */}
